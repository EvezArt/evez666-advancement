...
cd /root/.openclaw/workspace/evez-autonomous-ledger
...
cat > /root/.openclaw/workspace/_evez/ci/quick_status_evez-autonomous-ledger.json << EOF
{
  "timestamp": "$TIMESTAMP",
  "repo": "evez-autonomous-ledger",
  "branch": "$BRANCH",
...
echo "✓ evez-autonomous-ledger: $SYNTAX_OK"
